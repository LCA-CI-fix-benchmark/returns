...
# Run mypy check for returns
poetry run mypy --enable-error-code=unused-awaitable returns --file tests/test_examples/test_context/test_reader_future_result.py returns_check.py

# Run tests
poetry run mypy tests --file tests/test_examples/test_context/test_reader_future_result.py
